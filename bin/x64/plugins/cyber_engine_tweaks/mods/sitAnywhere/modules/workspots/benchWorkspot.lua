...
function bench:new(id, interactionPosition, workspotPosition, workspotRotation, mod)
	local o = {}
    ...
    o.devicePath = "sit_anywhere\\devices\\bench_lap.ent"
...
function bench:init()
    ...
    self.workspot.slideBlink = self.slideBlink
