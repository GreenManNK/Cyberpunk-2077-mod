...
function TweakDBRecordTypes.GetTweakDBRecordTypes(RecordType)
	...
	if (RecordType) == "VehicleDriveModelData" then
		...
		"bankBodyLRTanMultiplier", "bikeCurvesPath", "bikeMaxTilt", "bikeTiltCustomSpeed", 
		"bikeTiltPID", "bikeTiltReturnSpeed", "bikeTiltSpeed", "bodyFriction", 
		"brakingEstimationMagicFactor", "brakingFrictionFactor", "burnOut", 
		"center_of_mass_offset", "chassis_mass", "differentialOvershootFactor", 
		"driveHelpers", "flatTireSim", "forwardWeightTransferFactor", "handbrakeBrakingTorque", 
		...
		"smoothWheelContactDecreaseTime","smoothWheelContactIncreseTime","tankAcceleration",
		"tankCTOD","tankCTOI","tankCTOP","tankDeceleration","tankGravityMul","tankMaxSpeed",
		"tankSpringDamping","tankSpringDistance","tankSpringRadius","tankSpringsLocalPositions",
		"tankSpringStiffness","tankSpringVerticalOffset","tankTurningSpeed","total_mass",
