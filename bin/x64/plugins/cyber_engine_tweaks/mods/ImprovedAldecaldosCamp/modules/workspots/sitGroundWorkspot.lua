...
function sitGround:new(id, interactionPosition, workspotPosition, workspotRotation)
    ...
    o.devicePath = "base\\gameplay\\devices\\arcade_machines\\sit_ground.ent"
    o.name = localized.object.edge

    o.entryText = "[" .. localized.action.sit .. "]"
    o.entryIcon = "ChoiceCaptionParts.SitIcon"
    o.exitText = "[" .. localized.action.standUp .. "]"
