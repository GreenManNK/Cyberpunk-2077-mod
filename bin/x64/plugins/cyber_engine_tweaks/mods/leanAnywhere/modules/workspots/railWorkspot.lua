...
function rail:new(id, interactionPosition, workspotPosition, workspotRotation, mod)
	local o = {}
    ...
    o.devicePath = "lean_anywhere\\rail_lean.ent"
    ...
    o.workspotCameraRot = EulerAngles.new(2.25, 0, 0)
